...
class GroupThreeScreen extends StatefulWidget {
  const GroupThreeScreen({super.key});

  static String id = 'group_three_view';

  @override
  State<StatefulWidget> createState() => _GroupThreeScreen();
}

class _GroupThreeScreen extends State<GroupThreeScreen> {
  String? userImageUrl;
  String? userNickname;
                          ...
                          TextButton(
                            ...
                            child: Container(
                              ...
                              child: const CustomAvatar(
                                  width: 80,
                                  height: 80,
                                  urlImage: 'assets/images/diary.png'),
                            ),
                          ),
                          TextButton(
                            onPressed: () {},
